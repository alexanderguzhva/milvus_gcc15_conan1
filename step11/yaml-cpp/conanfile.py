...
class YamlCppConan(ConanFile):
    ...
    def source(self):
        ...
        git = Git(self)
        git.clone(url="https://github.com/jbeder/yaml-cpp.git", target=".") # Clone the repository
        git.checkout("aa8d4e4750ec9fe9f8cc680eb90f1b15955c817e") # Checkout a specific commit hash
